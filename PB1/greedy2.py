...
def main(args):
    ...
    print(f"Greedy2 time: {time.time() - current_time:.4f} seconds")

    current_time = time.time()
    greedy2Cost = compute_cost(caches2, endpoints, requests)
    print(f"[{time.time() - current_time:.4f}s] Greedy2 : {greedy2Cost}")
    print(f"Improvement: {greedyCost - greedy2Cost} ({(greedyCost - greedy2Cost) / greedyCost * 100:.2f}%)")
    ...
    print(f"Improvement from greedy2: {greedy2Cost - localSearchCost} ({(greedy2Cost - localSearchCost) / greedy2Cost * 100:.2f}%)")
    ...
    print(f"Local search on greedy2 time: {time.time() - current_time:.4f} seconds")

    localSearchCost2 = compute_cost(caches2, endpoints, requests)
    print(f"Local search on greedy2 : {localSearchCost2}")
    print(f"Improvement: {greedy2Cost - localSearchCost2} ({(greedy2Cost - localSearchCost2) / greedy2Cost * 100:.2f}%)")
